...
Kerberos is mainly used when an account wants to use services on the network, without prompting the user to re-enter credentials whenever a service requires authentication.
