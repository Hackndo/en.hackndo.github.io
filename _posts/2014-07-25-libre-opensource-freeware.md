---
title: 'Free, open source & freeware'
...
>   3. The right to redistribute the software
>   4. The right to modify and then redistribute the software (free of charge or not)
...
_However, there is a more technical difference: Free software, unlike open source, does not include tivoized devices in its philosophy. (Tivoized (or tyrannical) devices contain non-free executables made from free source code.)_

**Freewares**, on the other hand, are completely different. They are often associated with free software because the word _free_ in English has two distinct meanings: _libre_ and _gratis_. While we are indeed talking about free software (_libre_) when we speak of _free software_, the word _free_ in _freeware_ takes the meaning of _gratis_. But free software has no obligation to be free of charge, just as software that's free of charge has no obligation to be open source, and even less to be under a free license.
